...
function M.setup(theme, opts)
    ...
    local highlights = {
        ...
        ["@keyword.return"] = { fg = theme.syn.special5 },
        ["@keyword.exception"] = { fg = theme.syn.special4 },
        ["@keyword.import"] = { fg = theme.syn.special6, bold = true },
        ["@keyword.export"] = { link = "@keyword.import" },
        ["@operator"] = { fg = theme.syn.operator, bg = "NONE" },
        ["@type"] = { fg = theme.syn.special1, bg = "NONE", bold = true },
        ["@type.qualifier"] = { link = "@type" },
        ["@structure"] = { fg = theme.syn.identifier, bg = "NONE" },
        ["@tag"] = { fg = theme.syn.number, bg = "NONE", bold = true },
